...
SELECT o.customerNumber, o.orderNumber,o.orderDate, p.productName,
...
-- DROP VIEW vwCustomer_Order;  -- just in case you make a mistake, then you can drop it to recreate it.
...
SELECT v.*
FROM vwCustomer_Order v JOIN orderdetails d ON v.orderNumber = d.orderNumber
